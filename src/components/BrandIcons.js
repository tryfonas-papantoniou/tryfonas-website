/**
 * Inline brand icons. lucide-react removed these in recent versions,
 * so we ship our own using the official Simple Icons SVG paths.
 * Props mirror the lucide-react API: size, strokeWidth (unused here),
 * and any standard SVG props.
 */
